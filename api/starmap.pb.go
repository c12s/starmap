...
func (x *LayersResp) GetEntrypoints() map[string]*Entrypoint {
	if x != nil {
...
type GetMissingLayersResp struct {
	...
	Entrypoints      map[string]*Entrypoint      `protobuf:"bytes,10,rep,name=entrypoints,proto3" json:"entrypoints,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetMissingLayersResp) GetEntrypoints() map[string]*Entrypoint {
	if x != nil {
		return x.Entrypoints
	}
	return nil
...
const file_starmap_proto_rawDesc = "" +
	...
	"newVersion\x12\x16\n" +
	"\x06layers\x18\x06 \x03(\tR\x06layers\"\x93\x06\n" +
	"\n" +
	"LayersResp\x12D\n" +
	...
	"\x06events\x18\x04 \x03(\v2\x1d.proto.LayersResp.EventsEntryR\x06events\x12D\n" +
	"\ventrypoints\x18\x05 \x03(\v2\".proto.LayersResp.EntrypointsEntryR\ventrypoints\x1aQ\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.proto.EntrypointR\x05value:\x028\x01\"\xab\x01\n" +
	...
	"maintainer\x12\x16\n" +
	"\x06layers\x18\x05 \x03(\tR\x06layers\"\xed\a\n" +
	...
	"\x06events\x18\t \x03(\v2'.proto.GetMissingLayersResp.EventsEntryR\x06events\x12N\n" +
	"\ventrypoints\x18\n" +
	" \x03(\v2,.proto.GetMissingLayersResp.EntrypointsEntryR\ventrypoints\x1aQ\n" +
	"\x10DataSourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.proto.DataSourceR\x05value:\x028\x01\x1a[\n" +
	"\x15StoredProceduresEntry\x12\x10\n" +
...
var file_starmap_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_starmap_proto_goTypes = []any{
	(*SearchReq)(nil),               // 0: proto.SearchReq
	(*ExtendReq)(nil),               // 1: proto.ExtendReq
	(*TimelineReq)(nil),             // 2: proto.TimelineReq
	(*TimelineResp)(nil),            // 3: proto.TimelineResp
	(*SwitchCheckpointResp)(nil),    // 4: proto.SwitchCheckpointResp
	(*SwitchCheckpointReq)(nil),     // 5: proto.SwitchCheckpointReq
	(*LayersResp)(nil),              // 6: proto.LayersResp
	(*GetMissingLayersReq)(nil),     // 7: proto.GetMissingLayersReq
	(*GetMissingLayersResp)(nil),    // 8: proto.GetMissingLayersResp
	(*GetChartIdReq)(nil),           // 9: proto.GetChartIdReq
	(*DeleteChartReq)(nil),          // 10: proto.DeleteChartReq
	(*GetChartsLabelsReq)(nil),      // 11: proto.GetChartsLabelsReq
	(*GetChartsLabelsResp)(nil),     // 12: proto.GetChartsLabelsResp
	(*GetChartFromMetadataReq)(nil), // 13: proto.GetChartFromMetadataReq
	...
	nil,                             // 22: proto.LayersResp.EntrypointsEntry
	nil,                             // 23: proto.GetMissingLayersResp.DataSourcesEntry
	nil,                             // 24: proto.GetMissingLayersResp.StoredProceduresEntry
	nil,                             // 25: proto.GetMissingLayersResp.EventTriggersEntry
	nil,                             // 26: proto.GetMissingLayersResp.EventsEntry
	nil,                             // 27: proto.GetMissingLayersResp.EntrypointsEntry
	nil,                             // 28: proto.GetChartsLabelsReq.LabelsEntry
	(*StarChart)(nil),               // 29: proto.StarChart
	(*MetadataChart)(nil),           // 30: proto.MetadataChart
	(*Chart)(nil),                   // 31: proto.Chart
	(*DataSource)(nil),              // 32: proto.DataSource
	(*StoredProcedure)(nil),         // 33: proto.StoredProcedure
	(*EventTrigger)(nil),            // 34: proto.EventTrigger
	(*Event)(nil),                   // 35: proto.Event
	(*Entrypoint)(nil),              // 36: proto.Entrypoint
	(*EmptyMessage)(nil),            // 37: proto.EmptyMessage
}
var file_starmap_proto_depIdxs = []int32{
	...
	29, // 2: proto.ExtendReq.chart:type_name -> proto.StarChart
	...
	22, // 11: proto.LayersResp.entrypoints:type_name -> proto.LayersResp.EntrypointsEntry
	23, // 12: proto.GetMissingLayersResp.dataSources:type_name -> proto.GetMissingLayersResp.DataSourcesEntry
	24, // 13: proto.GetMissingLayersResp.storedProcedures:type_name -> proto.GetMissingLayersResp.StoredProceduresEntry
	25, // 14: proto.GetMissingLayersResp.eventTriggers:type_name -> proto.GetMissingLayersResp.EventTriggersEntry
	26, // 15: proto.GetMissingLayersResp.events:type_name -> proto.GetMissingLayersResp.EventsEntry
	27, // 16: proto.GetMissingLayersResp.entrypoints:type_name -> proto.GetMissingLayersResp.EntrypointsEntry
	28, // 17: proto.GetChartsLabelsReq.labels:type_name -> proto.GetChartsLabelsReq.LabelsEntry
	14, // 18: proto.GetChartsLabelsResp.charts:type_name -> proto.GetChartResp
	30, // 19: proto.GetChartResp.metadata:type_name -> proto.MetadataChart
	31, // 20: proto.GetChartResp.chart:type_name -> proto.Chart
	32, // 21: proto.LayersResp.DataSourcesEntry.value:type_name -> proto.DataSource
	33, // 22: proto.LayersResp.StoredProceduresEntry.value:type_name -> proto.StoredProcedure
	34, // 23: proto.LayersResp.EventTriggersEntry.value:type_name -> proto.EventTrigger
	35, // 24: proto.LayersResp.EventsEntry.value:type_name -> proto.Event
	36, // 25: proto.LayersResp.EntrypointsEntry.value:type_name -> proto.Entrypoint
	32, // 26: proto.GetMissingLayersResp.DataSourcesEntry.value:type_name -> proto.DataSource
	33, // 27: proto.GetMissingLayersResp.StoredProceduresEntry.value:type_name -> proto.StoredProcedure
	34, // 28: proto.GetMissingLayersResp.EventTriggersEntry.value:type_name -> proto.EventTrigger
	35, // 29: proto.GetMissingLayersResp.EventsEntry.value:type_name -> proto.Event
	36, // 30: proto.GetMissingLayersResp.EntrypointsEntry.value:type_name -> proto.Entrypoint
	29, // 31: proto.RegistryService.PutChart:input_type -> proto.StarChart
	13, // 32: proto.RegistryService.GetChartMetadata:input_type -> proto.GetChartFromMetadataReq
	11, // 33: proto.RegistryService.GetChartsLabels:input_type -> proto.GetChartsLabelsReq
	9,  // 34: proto.RegistryService.GetChartId:input_type -> proto.GetChartIdReq
	37, // 35: proto.RegistryService.GetCharts:input_type -> proto.EmptyMessage
	7,  // 36: proto.RegistryService.GetMissingLayers:input_type -> proto.GetMissingLayersReq
	10, // 37: proto.RegistryService.DeleteChart:input_type -> proto.DeleteChartReq
	29, // 38: proto.RegistryService.UpdateChart:input_type -> proto.StarChart
	5,  // 39: proto.RegistryService.SwitchCheckpoint:input_type -> proto.SwitchCheckpointReq
	2,  // 40: proto.RegistryService.Timeline:input_type -> proto.TimelineReq
	1,  // 41: proto.RegistryService.Extend:input_type -> proto.ExtendReq
	0,  // 42: proto.RegistryService.Search:input_type -> proto.SearchReq
	15, // 43: proto.RegistryService.PutChart:output_type -> proto.PutChartResp
	14, // 44: proto.RegistryService.GetChartMetadata:output_type -> proto.GetChartResp
	12, // 45: proto.RegistryService.GetChartsLabels:output_type -> proto.GetChartsLabelsResp
	14, // 46: proto.RegistryService.GetChartId:output_type -> proto.GetChartResp
	12, // 47: proto.RegistryService.GetCharts:output_type -> proto.GetChartsLabelsResp
	8,  // 48: proto.RegistryService.GetMissingLayers:output_type -> proto.GetMissingLayersResp
	37, // 49: proto.RegistryService.DeleteChart:output_type -> proto.EmptyMessage
	15, // 50: proto.RegistryService.UpdateChart:output_type -> proto.PutChartResp
	4,  // 51: proto.RegistryService.SwitchCheckpoint:output_type -> proto.SwitchCheckpointResp
	3,  // 52: proto.RegistryService.Timeline:output_type -> proto.TimelineResp
	15, // 53: proto.RegistryService.Extend:output_type -> proto.PutChartResp
	12, // 54: proto.RegistryService.Search:output_type -> proto.GetChartsLabelsResp
